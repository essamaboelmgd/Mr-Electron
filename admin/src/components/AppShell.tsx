...
export const AppShell = ({ children }: { children: ReactNode }) => {
  ...
  if (!user) return null;
  return <div className="admin-shell"><Header user={user} /><div className="admin-body"><Sidebar /><main className="admin-main"><div className="admin-frame">{children}</div></main></div></div>;
};
