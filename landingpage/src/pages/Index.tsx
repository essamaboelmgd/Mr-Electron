...
export default function Index() {
  ...
  return (
    <div className="landing-shell">
      ...
      <footer className="landing-footer page-width"><a className="landing-brand" href="#home"><span className="landing-mark" aria-hidden="true"><i /><i /><i /></span><span><strong>mr electron</strong><small>منصة العلوم</small></span></a><span>منهج مرتب. فهم أعمق.</span><div><a href={loginUrl}>دخول الطالب</a><a href={adminUrl}>دخول المدرس</a></div><a className="landing-credit" href="https://wa.me/201062772291" target="_blank" rel="noopener noreferrer" aria-label="التواصل مع Essam Abo Elmgd على واتساب"><MessageCircle size={15} aria-hidden="true" /><span>Developed by Essam Abo Elmgd</span></a></footer>
    </div>
  );
}
